...
install:
	...
	@yay -Syu linuxqq wemeet-bin wechat-uos v2raya ttf-symbola bibata-cursor-theme adw-gtk3-git rime-ice-pinyin-git
	...
	@# setup git
	@git config --global user.name "Ya Qia"
	@git config --global user.email "yyaqia@gmail.com"
